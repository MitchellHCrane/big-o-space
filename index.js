...
// ANSWER: No, no matter how many arrays you have it still will run through numbers.length and be linear or o(n)
...
// ANSWER: O(1) is the first function and the second O(n)
...
// ANSWER: Each function is dependent on the size of the string i guess
